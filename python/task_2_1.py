# -*- coding: utf-8 -*-
"""
Created on Tue Apr 19 12:34:53 2022
...
I1 = cv.imread('../data_hw5_ext/IMG_8220.jpg', cv.IMREAD_GRAYSCALE)
I2 = cv.imread('../data_hw5_ext/IMG_8221.jpg', cv.IMREAD_GRAYSCALE)
...
sift = cv.SIFT_create(nfeatures=100000,edgeThreshold=9)
...
# "unique" (cross-check).
index_pairs, match_metric = match_features(desc1, desc2, max_ratio=1.0, unique=False)
...
np.savetxt('../data_hw5_ext/calibration/kp1.txt',kp1[index_pairs[:,0]])
np.savetxt('../data_hw5_ext/calibration/kp2.txt',kp2[index_pairs[:,1]])
